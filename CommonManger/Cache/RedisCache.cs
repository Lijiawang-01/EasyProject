...
namespace CommonManager.Cache
{
    public class RedisCache : IRedisCache
    {
        ...
        public RedisCache()
        {
            ...
            var redisHost = AppSettingHelper.ReadAppSettings("Redis", "host");
            var redisPort = AppSettingHelper.ReadAppSettings("Redis", "port").ObjToInt();
                ...
                EndPoints =
            {
                ...
                KeepAlive = 180,
                Password = AppSettingHelper.ReadAppSettings("Redis", "password"),
                AllowAdmin = true
            };
        ...
        private string InitKey(string key)
        {
            ...
            return $"{AppSettingHelper.ReadAppSettings("Redis", "preName")}{key}";
        }
